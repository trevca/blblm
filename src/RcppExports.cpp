...
RcppExport SEXP _blblm_fastLm_impl(SEXP XSEXP, SEXP ySEXP, SEXP wSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fastLm_impl(X, y, w));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_blblm_fastLm_impl", (DL_FUNC) &_blblm_fastLm_impl, 3},
    {NULL, NULL, 0}
};
